            ...
            <div className="container mx-auto max-w-4xl px-4 text-center">
                ...
                <div className="text-xs text-slate-500 space-y-4 max-w-3xl mx-auto !mt-12">
                    ...
                    <div className="flex justify-center items-center gap-x-4 gap-y-1 flex-wrap !mt-4">
                        <a href="https://www.shewolfai.com" target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-gold-400 text-slate-400 transition-colors">SHE-WOLF AI</a>
                        <span className="text-slate-600">|</span>
                        ...
                        <span className="text-slate-600">|</span>
                        <a href="https://www.kingley.org" target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-gold-400 text-slate-400 transition-colors">TRAINING</a>
                    </div>
